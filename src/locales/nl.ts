...
export const nl = {
  ...
  'models.manage.languageAvailabilityTitle': 'Beschikbaarheid voor {language}',
  'models.manage.languageAvailability_none': 'Geen compatibel model',
  'models.manage.languageAvailability_installed_one': '{count} geïnstalleerd',
  'models.manage.languageAvailability_installed_other': '{count} geïnstalleerd',
  'models.manage.languageAvailability_downloads_one': '{count} compatibele download',
  'models.manage.languageAvailability_downloads_other': '{count} compatibele downloads',
