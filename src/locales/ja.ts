...
export const ja = {
  ...
  'ribbon.queue.normal': 'キューは正常',
  'ribbon.queue.catchingUp': '処理赶上中',
  'ribbon.queue.fallingBehind': '文字起こしが遅れれています',
  'ribbon.queue.saturated': 'キューが一杯です — ディクテーションを一時停止してください',
  ...
  'translation.modal.reopen': '翻訳を再開: {status}',
