...
export const hr = {
  ...
  'models.manage.languageAvailabilityTitle': 'Dostupnost za {language}',
  'models.manage.languageAvailability_none': 'Nema kompatibilnog modela',
  'models.manage.languageAvailability_installed_one': '{count} instaliran',
  'models.manage.languageAvailability_installed_other': '{count} instalirani',
  'models.manage.languageAvailability_downloads_one': '{count} kompatibilno preuzimanje',
  'models.manage.languageAvailability_downloads_other': '{count} kompatibilna preuzimanja',
