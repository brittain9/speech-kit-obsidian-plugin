...
export const pt = {
  ...
  'ribbon.queue.normal': 'Fila normal',
  'ribbon.queue.catchingUp': 'A recuperar',
  'ribbon.queue.fallingBehind': 'A transcrição está atrasada',
  'ribbon.queue.saturated': 'Fila cheia — pause o ditado',
  ...
  'translation.modal.reopen': 'Reabrir tradução: {status}',
