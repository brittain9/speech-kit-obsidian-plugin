...
export const pt = {
  ...
  'models.manage.languageAvailabilityTitle': 'Disponibilidade para {language}',
  'models.manage.languageAvailability_none': 'Nenhum modelo compatível',
  ...
  'models.manage.languageAvailability_downloads_one': '{count} transferência compatível',
  'models.manage.languageAvailability_downloads_other': '{count} transferências compatíveis',
